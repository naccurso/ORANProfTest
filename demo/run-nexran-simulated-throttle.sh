...
curl -i -X POST -H "Content-type: application/json" -d '{"name":"fast","allocation_policy":{"type":"proportional","share":1024,"auto_equalize":false,"throttle":true,"throttle_threshold":6800000,"throttle_period":1800,"throttle_share":256}}' http://${NEXRAN_XAPP}:8000/v1/slices ; echo ; echo ;
